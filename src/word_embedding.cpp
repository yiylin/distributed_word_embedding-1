...
namespace multiverso
{
    namespace wordembedding
    {
		...
		inline void WordEmbedding::TrainParse(int *feat, int feat_cnt, int word_idx, real *hidden_act, real *hidden_err)
		{
		...
		inline void WordEmbedding::BPOutputLayer(int label,
